...
void TechnoExt::ExtData::Serialize(T& Stm)
{
	Stm
		...
		.Process(this->FormationOffsetValid)
		.Process(this->FormationOffsetX)
		.Process(this->FormationOffsetY)
		.Process(this->FormationMoveActive)
		.Process(this->FormationMoveSpeed)
		.Process(this->FormationMoveMaxSpeed)
		.Process(this->FormationShape)
