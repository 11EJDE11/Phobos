...
void RulesExt::ExtData::LoadBeforeTypeData(RulesClass* pThis, CCINIClass* pINI)
{
	...
	this->Pips_Formation_Frame.Read(exINI, GameStrings::AudioVisual, "Pips.Formation.Frame");
	this->Pips_Formation_Offset.Read(exINI, GameStrings::AudioVisual, "Pips.Formation.Offset");
...
void RulesExt::ExtData::Serialize(T& Stm)
{
	Stm
		...
		.Process(this->Pips_Formation_Frame)
		.Process(this->Pips_Formation_Offset)
